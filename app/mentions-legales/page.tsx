    ...
    <div className="container py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-primary">INFORMATIONS ÉDITORIALES</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-primary">NOUS CONTACTER</h2>
            <div className="bg-gray-50 p-6 rounded-lg space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-primary">PRESTATAIRE D'HÉBERGEMENT</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-primary">CONDITIONS GÉNÉRALES D'UTILISATION DU SITE</h2>
            <div className="bg-gray-50 p-6 rounded-lg">
              <p>
                L'utilisation du site https://taxi-dumoulin.com implique l'acceptation pleine et entière des conditions
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-primary">LIMITATIONS DE RESPONSABILITÉS</h2>
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
              <p>
                Taxi Dumoulin ne pourra être tenu responsable des dommages directs et indirects causés au matériel de
                l'utilisateur, lors de l'accès au site https://taxi-dumoulin.com.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
              <p>
                ...
                de Taxi Dumoulin à l'exception des marques, logos ou contenus appartenant à d'autres sociétés
                partenaires ou auteurs.
              </p>
              <p>
                Toute reproduction, distribution, modification, adaptation, retransmission ou publication, même
                partielle, de ces différents éléments est strictement interdite sans l'accord exprès par écrit de Taxi
                Dumoulin.
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-primary">DONNÉES PERSONNELLES</h2>
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
              <p>
              ...
              <p>
                ...
                prénom, votre adresse électronique, et votre numéro de téléphone. Tel est le cas lorsque vous remplissez
                le formulaire qui vous est proposé en ligne, dans les rubriques « contact » et « réservation ».
              </p>
              <p>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
              <p>
                ...
                besoins de statistiques et d'affichage. Un cookie est une information déposée sur votre disque dur par
