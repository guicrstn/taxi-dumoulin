            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 mb-4">
                  ...
                  <li className="flex items-start gap-2">
                    <Users className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span>Véhicule confortable et bien équipé</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 mb-4">
                  ...
                  <li className="flex items-start gap-2">
                    <MapPin className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span>Service pour toute la France</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Users className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
            ...
            <Card className="border-l-4 border-l-orange-500">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle>Transport colis international</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Service de transport pour vos colis. NNous proposons des tarifs fixes et transparents.
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-start gap-2">
                    <Clock className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <Users className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span>Rapide, Assurée, véhicule équipé</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
